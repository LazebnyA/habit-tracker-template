...
export const registerUser = createAsyncThunk("user/register", async (userInfo, thunkAPI) => {
    ...
    try {
        ...
        const url = `${process.env.REACT_APP_SERVER_URL}/user/register?firstName=${encodeURIComponent(firstName)}&lastName=${encodeURIComponent(lastName)}&email=${encodeURIComponent(email)}&password=${encodeURIComponent(password)}&passwordConfirm=${encodeURIComponent(passwordConfirm)}`;
...
export const signinUser = createAsyncThunk("user/signin", async (userInfo, thunkAPI) => {
    ...
    try {
        const url = `${process.env.REACT_APP_SERVER_URL}/user/signin?email=${encodeURIComponent(email)}&password=${encodeURIComponent(password)}`;

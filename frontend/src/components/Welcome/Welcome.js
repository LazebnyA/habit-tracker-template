                ...
                <section className="features">
                    <div className="container featuresContainer">
                        <div className="featureItem feature1">
                            ...
                            <img src="/images/mountainImage1.jpg" className="featureDecoration featureDecorItem1" alt={""}/>
                        </div>
                        <div className="featureItem feature2">
                            <img src="/images/mountainImage2.jpg" className="featureDecoration featureDecorItem2" alt={""}/>
                            <div className="featureText">
                                <h3 className="featureHeading">
